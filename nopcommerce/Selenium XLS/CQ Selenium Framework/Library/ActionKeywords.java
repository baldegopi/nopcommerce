...
public static String Enterurl(WebDriver driver,String object, String data, String locator, TestReport testReport){
                   try{
                           testReport.fillStepValue("Enterurl");
                   boolean found;
                           
                           //TODO: implement code here for checking Enterurl, remove below line after implementing
                           NewLog.getLogger().error("Implementation of method Enterurl is missing in Library\\ActionKeywords.java");
                   ...
                   if (found)
                   {
                           ...
                           NewLog.getLogger().error(" Exception (method Enterurl,ActionKeywords.java): Could not locate object" +object+" is missing for Enterurl in application -"+e.getMessage());
